...
export function mapPerUserPushedDataToStateObjects(
  fbc,
  userRefKey,
  component,
  stateKey,
  ...
  convertPerUserDataToState(
    ...
    (newState, userId, key, value, keyInUserData) =>
      (newState[key] = { ...value, userId, id: key }),
  )
}
...
export function mapPerUserPushedDataToObjectOfStateObjects(
  fbc,
  userRefKey,
  component,
  stateKey,
...
export function reducePerUserDataToStateCount(
  fbc,
  userRefKey,
  component,
  stateKey,
...
export function convertPerUserDataToState(
  fbc,
  userRefKey,
  component,
  stateKey,
...
export function mapPerUserPrivatePushedDataToStateObjects(
  fbc,
  userRefKey,
  component,
  stateKey,
  ...
  convertPrivatePerUserDataToState(
    fbc,
    userRefKey,
    component,
    stateKey,
...
export function mapPerUserPrivatePushedDataToObjectOfStateObjects(
  fbc,
  userRefKey,
  component,
  stateKey,
...
export function convertPrivatePerUserDataToState(
  fbc,
  userRefKey,
  component,
  stateKey,
