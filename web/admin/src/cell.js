...
export default class CustomCell extends Component {
          ...
          <div className='cellBox'>
            <div className='cellBoxLeft'>
              ...
              <p className="nameText">
                {(this.state.question ? "-" + this.state.question.creator.firstName + " " + this.state.question.creator.lastName : "unavailable")}
              </p>
            </div>
          </div>
          <div className='cellBox'>
            <div className='cellBoxLeft'>
              ...
              <div className="cellBoxTop">
                <p className="nameText">
                  {(content.creator ? "-" + content.creator.firstName + " " + content.creator.lastName : "unavailable")}
                </p>
                {this.returnUsers()}
              </div>
            </div>
  ...
  returnUsers = () => {
    ...
    reports.map((item, i) => {
      ...
      const name = (user ? user.firstName + " " + user.lastName : "unavailable")
